...
//    AVCodec *pCodec = avcodec_find_decoder_by_name((const char *) pCodeCtx->codec_id);
//    if (pCodec == NULL) {
//        LOGE("%s", "无法解码");
//        return;
//    }
...
//
//    struct SwsContext *sws_ctx = sws_getContext(pCodeCtx->width, pCodeCtx->height,
//                                                pCodeCtx->pix_fmt, pCodeCtx->width,
//                                                pCodeCtx->height,
